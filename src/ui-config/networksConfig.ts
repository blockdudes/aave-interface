...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  ...
  [ChainId.avalanche]: {
    name: 'Avalanche',
    privateJsonRPCUrl:
      'https://avax-mainnet.gateway.pokt.network/v1/lb/62f89f9b09459a003923366b/ext/bc/C/rpc',
  ...
  [ChainId.optimism]: {
    name: 'Optimism',
    privateJsonRPCUrl:
      'https://optimism-mainnet.gateway.pokt.network/v1/lb/62f89f9b09459a003923366b',
